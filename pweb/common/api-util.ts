...
import {RapidException, RapidHTTResponse, RapidLoadDataPrams} from "react-rapid-app";
...
export const ApiUtil = {
    ...
    getResponseRawContent: (response: RapidHTTResponse) => {
        ...
        if (!response.isSuccess || !response.responseData) {
            ...
            throw new RapidException(errorMessage)
        }
        return response.responseData
    },

    inspectResponseValidationError: (response: RapidHTTResponse) => {
        ...
        if (responseData.status === AppConstant.STATUS_ERROR) {
            ...
            throw new RapidException(errorMessage).setErrorDetails(responseData)
        }
        return responseData
    },

    inspectResponseAndShowValidationError: (response: RapidHTTResponse, component: any) => {
        ApiUtil.getValidResponseOrNone(response, component)
    },

    getValidResponseOrNone: (response: RapidHTTResponse, component: any) => {
        let errorMessage = AppMessage.somethingWentWrong;
    ...
    getSearchSortAndPaginationData: (component: any, dataParams: RapidLoadDataPrams = new RapidLoadDataPrams()) => {
